# Signal audio manifest

These full-length MP3 files were supplied by the artist for the Viryn Studio Signal proof of concept. Playback and downloads are permitted for this demonstration.

| File | Public title | Artist display | Status | Credits | Duration |
|---|---|---|---|---|---|
...
The listening-room access phrase is an interface demonstration, not security. GitHub Pages serves these media files publicly when their URLs are known.
